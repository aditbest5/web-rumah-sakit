          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="about-widget">
              <div class="footer-logo">
                <figure>
                  <a href="/home">
                    <img src="{{asset('/medic-master/images/logo-2.png')}}" alt="">
                  </a>
                </figure>
              </div>
                ...
                <li class="item">
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img class="media-object" src="{{asset('/medic-master/images/blog/post-thumb-small.jpg')}}" alt="post-thumb">
                      </a>
                    </div>
    ...
    <div class="footer-bottom">
      <div class="container clearfix">
        ...
        <ul class="footer-bottom-link">
          ...
          <li>
            <a href="{{asset('/medic-master/contact.html')}}">Contact</a>
          </li>
        </ul>
      </div>
    </div>
