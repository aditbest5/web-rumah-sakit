                ...
                <div class="left-side">
                    <div class="item-holder">
                        ...
                        <div class="content-text">
                            <a href="/single-blog"><h5>A LESSON IN SURGERY PREPAREDNESS - FROM HURRICANE SEASON</h5></a>
                ...
                <div class="comments-area">
                    ...
                    <div class="comment">
                        <div class="image-holder">
                            <figure>
                                <img src="{{asset('/medic-master/images/blog/1.png')}}" alt="">
                            </figure>
                        </div>
                    ...
                    <div class="comment reply-comment">
                        <div class="image-holder">
                            <figure>
                                <img src="{{asset('/medic-master/images/blog/2.png')}}" alt="">
                            </figure>
                        </div>
                        <div class="image-text">
                    ...
                    <div class="comment">
                        <div class="image-holder">
                            <figure>
                                <img src="{{asset('/medic-master/images/blog/3.png')}}" alt="">
                            </figure>
                        </div>
                        <div class="image-text">
