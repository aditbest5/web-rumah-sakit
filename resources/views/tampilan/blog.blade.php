            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="left-side">
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="/single-blog"><img src="{{asset('/medic-master/images/blog/5.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                            <a href="/single-blog"><h6>A LESSON IN SURGERY PREPAREDNESS - FROM HURRICANE SEASON</h6></a>
                            ...
                            <div class="link-btn">
                                <a href="/single-blog" class="btn-style-one">read more</a>
                            </div>
                        </div>
                    </div>
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="/single-blog"><img src="{{asset('/medic-master/images/blog/6.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                            <a href="/single-blog"><h6>PATIENT ENGAGEMENT AND THE IMPROVEMENT OF CARE AND RECOVERY</h6></a>
                    ...
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="/single-blog"><img src="{{asset('/medic-master/images/blog/7.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                            <a href="/single-blog"><h6>HOW TO MAKE YOUR MEDICAL TRAINING EVENT OVER THE TOP</h6></a>
                    ...
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="/single-blog"><img src="{{asset('/medic-master/images/blog/8.jpg')}}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                            <a href="/single-blog"><h6>WHAT DOES THE FLEXDEX BRING TO LAPAROSCOPY?</h6></a>
