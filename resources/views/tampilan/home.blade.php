            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content text-center style">
                        ...
                        <a href="{{asset('shop.html')}}" class="btn btn-main btn-white">shop now</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{asset('/medic-master/images/resource/1.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Orthopedics</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{asset('/medic-master/images/resource/2.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Diaginostic</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{asset('/medic-master/images/resource/3.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Psycology</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{asset('/medic-master/images/resource/4.png')}}" alt="">
										</a>
									</figure>
								</div>
...
<!--Start about us area-->
<section class="service-tab-section team-section section">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#dormitory"  data-toggle="tab">Dokter Umum</a>
                            </li>
                            <li role="presentation">
                                <a href="#orthopedic" data-toggle="tab">Psikologi</a>
                            </li>
                            <li role="presentation">
                                <a href="#sonogram" data-toggle="tab">Gizi</a>
                            </li>
                            <li role="presentation">
                                <a href="#x-ray" data-toggle="tab">Kandungan</a>
                            </li>
                            <li role="presentation">
                                <a href="#diagnostic" data-toggle="tab">Penyakit Mata</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row items-container clearfix">
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="{{asset('/medic-master/service.html')}}">
                            <img src="{{asset('medic-master/images/gallery/1.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="{{asset('medic-master/service.html')}}">
                            <img src="{{asset('medic-master/images/gallery/2.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="{{asset('medic-master/service.html')}}">
                            <img src="{{asset('medic-master/images/gallery/3.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
        ...
        <div class="testimonial-carousel">
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{asset('medic-master/images/testimonials/1.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>Adam Rose</h6>
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{asset('medic-master/images/testimonials/2.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>David Warner</h6>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, at?</p>
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{asset('medic-master/images/testimonials/3.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>Amy Adams</h6>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, at?</p>
